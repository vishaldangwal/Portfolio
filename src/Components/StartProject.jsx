      ...
      <div className="px-6 py-5 bg-white border border-[#e6e6e6] rounded-lg hover:border-[#d0d0d0] transition-all duration-300">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="text-center md:text-left">
            <h2 className="text-lg font-medium mb-1">Start a Project</h2>
            <p className="text-base text-gray-600">
              Interested in working together? Let’s set up a time to chat.
            </p>
          </div>
          <div>
            <a
              href="/contact"
              className="inline-flex items-center gap-2 px-5 py-2.5 bg-gray-500 text-white font-semibold rounded-full hover:bg-gray-700 transition"
            >
              <svg
                className="w-4 h-4"
                aria-hidden="true"
              ...
              <span className="text-sm">Let's do this</span>
            </a>
          </div>
        </div>
      </div>
